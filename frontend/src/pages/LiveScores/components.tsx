...
export type AnalyzeHandler = (
  ...
  matchKey?: string,
  meta?: { matchState?: number; kickoff?: string; league?: string },
) => void
        ...
        {typeof fx.odds_h === 'number' && typeof fx.odds_d === 'number' && typeof fx.odds_a === 'number' && onAnalyze && (
          <button
            onClick={(e) => {
              ...
              const hasAH = fx.ah_line != null && fx.ah_home != null && fx.ah_away != null
              // 修复 defect 9: 无 OU 时不再连 AH 一起丢弃 — 有哪个盘传哪个盘
              const handicap = (hasOU || hasAH)
                ? {
                    ...(hasOU ? { ou_line: fx.ou_line, ou_over: fx.ou_over, ou_under: fx.ou_under } : {}),
                    ...(hasAH ? { ah_line: fx.ah_line, ah_home: fx.ah_home, ah_away: fx.ah_away } : {}),
                  }
                : undefined
              onAnalyze(
                ...
                (typeof fx.score_home === 'number' && typeof fx.score_away === 'number')
                  ...
                  : undefined,
                fx.match_key,
                { matchState: fx.match_state, kickoff: fx.commence_time, league: fx.league },
              )
            }}
