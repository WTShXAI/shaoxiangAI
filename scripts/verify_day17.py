"""哨响AI v5.2 — Day17 (6/17) 回测 — 验证Day16修复效果"""
import sys, os, json
...
print("=" * 65)
print(f"哨响AI v5.2 — Day 17 ({target}) 回测验证")
...
print()
print("滚动验证汇总:")
print(f"  Day14-15: 4/9=44% (持平旧版)")
print(f"  Day16: 3/3=100% (+33pp)")
print(f"  Day17: {dir_ok}/{total}={dir_ok/total*100:.0f}%")
print("=" * 65)
