...
class HandicapPipeline:
    ...
    def step1_labels(self) -> dict:
        ...
        from handicap_labeler import HandicapLabeler
    ...
    def step2_profiles(self) -> dict:
        ...
        from handicap_depth_mapper import HandicapDepthMapper
    ...
    def step3_inject(self) -> dict:
        ...
        from handicap_cover_predictor import HandicapCoverPredictor
